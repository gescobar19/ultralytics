...
def verify_image_label(args):
    ...
    try:
        ...
        if os.path.isfile(lb_file):
            ...
            if nl:
                if keypoint:
                    ...
                    points = lb[:, 1:6]  # Ensure correct indexing based on your label format
        ...
        lb = lb[:, :6]  # Ensure correct indexing based on your label format
